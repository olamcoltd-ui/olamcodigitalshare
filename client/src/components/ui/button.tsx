  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-primary text-white hover:shadow-lg transform hover:scale-105 transition-bounce shadow-primary",
        success: "bg-success text-success-foreground hover:bg-success/90 shadow-success",
        gradient: "bg-gradient-hero text-white hover:shadow-xl transform hover:scale-105 transition-bounce",
        premium: "bg-gradient-primary text-white border-2 border-white/20 hover:border-white/40 hover:shadow-xl transform hover:scale-105 transition-bounce",
      },
      size: {
